...
export default function Contact() {
    ...
    return (
        <div className="container flex justify-center items-center mx-auto h-min my-8 lg:my-0 lg:h-screen">
            <div className="flex flex-col items-center w-full">

                <h1 className="text-6xl"> Hubungi Kami </h1>
                
                <div className="flex flex-col w-full lg:flex-row">
                    <div className="w-full lg:w-1/2 mt-12">
                        <h2 className="text-4xl text-center mb-6"> Alamat </h2>
                        <div className="flex flex-col justify-center items-center">
                            <div className="w-2/3 aspect-square h-72 flex border-0 justify-center">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2921223750805!2d106.80039185049723!3d-6.225160862679051!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f1845cccaec9%3A0xe5cac6cae89e27bc!2sPusat%20Prestasi%20Nasional%2C%20Kementerian%20Pendidikan%2C%20Kebudayaaan%2C%20Riset%2C%20dan%20Teknologi!5e0!3m2!1sen!2sca!4v1672536524755!5m2!1sen!2sca" className="w-full h-full"  loading="lazy"></iframe>
                            </div>
